...
7. **Not Authoring** — Master CV Enrichment is not Master CV Authoring (skills, Sitting, Authoring write protocol). This ADR does not govern that family ([0018-master-cv-authoring.md](0018-master-cv-authoring.md)). Enrichment remains until Gate met (ADR-0018). Do not bounce an overlapping experience/projects/education deepen to Enrichment; that job is a Holistic Slice. Layout is not Enrichment's job.
