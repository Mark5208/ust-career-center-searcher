...
src/job_finding_assistant/
  assistant.py              # Assistant + AssessmentSummary + page loads + CandidateFilesView + Enrichment + Prepare/Bulk + LLM Run + CrawlOutcome
